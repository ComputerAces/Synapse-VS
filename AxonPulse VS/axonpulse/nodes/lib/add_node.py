...
@axon_node(category="Math/Arithmetic", version="2.3.0", node_label="Add")
def AddNode(A: Any = 0, B: Any = 0, _bridge: Any = None, _node: Any = None, _node_id: str = None, **kwargs) -> Any:
